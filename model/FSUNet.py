...
class FSUNet(nn.Module):
    def __init__(self, num_classes, encoder_relu=False, decoder_relu=True):
        ...
        # Stage 1
        self.downsample1_0 = DownsamplingBottleneck(16, 64, retrun_indices=True, dropout_p=0.01, relu=encoder_relu)
        ...
        # Stage 2
        self.downsample2_0 = DownsamplingBottleneck(64, 128, retrun_indices=True, dropout_p=0.1, relu = encoder_relu)
        self.regular2_1 = Bottleneck(128, padding=1, dropout_p=0.1, relu=encoder_relu)
        self.dilated2_2 = Bottleneck(128, dilation=2, padding=2, dropout_p=0.1, relu=encoder_relu)
        self.asymmetric2_3 = Bottleneck(128, kernel_size=5, padding=2, asymmetric=True, dropout_p=0.1, relu=encoder_relu)
        self.dilated2_4 = Bottleneck(128, dilation=4, padding=4, dropout_p=0.1, relu=encoder_relu)
        self.regular2_5 = Bottleneck(128, padding=1, dropout_p=0.1, relu=encoder_relu)
        self.dilated2_6 = Bottleneck(128, dilation=8, padding=8, dropout_p=0.1, relu=encoder_relu)
        self.asymmetric2_7 = Bottleneck(128, kernel_size=5, asymmetric=True, padding=2, dropout_p=0.1, relu=encoder_relu)
        self.dilated2_8 = Bottleneck(128, dilation=16, padding=16, dropout_p=0.1, relu=encoder_relu)
        ...
        self.dilated3_1 = Bottleneck(128, dilation=2, padding=2, dropout_p=0.1, relu=decoder_relu)
        self.asymmetric3_2 = Bottleneck(128, kernel_size=5, padding=2, asymmetric=True, dropout_p=0.1, relu=decoder_relu)
        self.dilated3_3 = Bottleneck(128, dilation=4, padding=4, dropout_p=0.1, relu=decoder_relu)
        self.regular3_4 = Bottleneck(128, padding=1, dropout_p=0.1, relu=decoder_relu)
        self.dilated3_5 = Bottleneck(128, dilation=8, padding=8, dropout_p=0.1, relu=decoder_relu)
        self.asymmetric3_6 = Bottleneck(128, kernel_size=5, asymmetric=True, padding=2, dropout_p=0.1, relu=decoder_relu)
        self.dilated3_7 = Bottleneck(128, dilation=16, padding=16, dropout_p=0.1, relu=decoder_relu)

        # Stage 4
        self.upsample4_0 = UpsamplingBottleneck(128, 64, dropout_p=0.1, relu=decoder_relu)
        ...
        # Stage 5
        self.upsample5_0 = UpsamplingBottleneck(64, 16, dropout_p=0.1, relu=decoder_relu)
        self.regular5_1 = Bottleneck(16, padding=1, dropout_p=0.1, relu=decoder_relu)

        self.transposed_conv_semantic = nn.ConvTranspose2d(16, num_classes, kernel_size=3, stride=2, padding=1, bias=False)
        self.transposed_conv_depth = nn.ConvTranspose2d(16, 1, kernel_size=3, stride=2, padding=1, bias=False)
